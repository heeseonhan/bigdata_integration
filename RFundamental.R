#book : 데이터분석 분석도구 R Fundamental (다양한 예제와 연습문제 수록)
#book : ISBN 9791158133276
#한희선 저 | 구민사 | 2016.11.05
#homepage : http://cafe.naver.com/dataan
